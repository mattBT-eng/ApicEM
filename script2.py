...
print('Adding actual leafs to switch profiles'+str([ApicEM.AddLeafSeltoSwitchProf(SwitchProfNames[i],SwProfNames[i]+'_Sel',Switches[i]) for i in range(len(Switches))]))
VPCPolGrpName = 'PolGrp_VPC_CCGTest_1718'
print('adding VPC to EPG'+ApicEM.AssociateVPCPort2EPG(tenant_name, apProfile, EPGname, '62', '1','101-102',VPCPolGrpName))
